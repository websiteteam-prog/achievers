...
<div class="sidebar" id="sidebar">
  ...
  <nav class="nav flex-column">
    ...
    <a class="nav-link <?= ($currentpage == 'branch_students.php') ? 'active' : '' ?>" href="branch_students.php"><i class="bi bi-mortarboard me-2"></i>Students</a>
    <a class="nav-link <?= ($currentpage == 'branch_teacher.php') ? 'active' : '' ?>" href="branch_teacher.php"><i class="bi bi-person-video3 me-2"></i>Teachers</a>
