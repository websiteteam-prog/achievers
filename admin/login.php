...
<title>Admin Login | Achiever's Castle</title>
...
<div class="auth-card">
  <div class="auth-left">
    ...
    <h2>Admin Panel</h2>
    <p>Secure control panel.<br>Manage everything in one place.</p>
    <span class="badge-role"><i class="bi bi-shield-lock-fill"></i> Administrator</span>
  </div>
  <div class="auth-right">
    <h3>Welcome Back</h3>
    <p class="lead">Sign in to your control panel</p>
